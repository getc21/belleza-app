    ...
    return Scaffold(
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          final category = _suppliers[index];
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          category['contact_name'] ?? 'Sin datos',
                          style: const TextStyle(
                            fontSize: 12.0,
                        ...
                        Text(
                          category['contact_email'] ?? 'Sin datos',
                          style: const TextStyle(
                            fontSize: 12.0,
                            color: Colors.black87,
                          ),
                        ...
                        Text(
                          category['contact_phone'] ?? 'Sin datos',
                          style: const TextStyle(
                            fontSize: 12.0,
                            color: Colors.black87,
                          ),
